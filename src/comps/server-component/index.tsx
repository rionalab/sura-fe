      ...
      <div>
         <div className="flex w-full flex-col gap-4 rounded-md bg-gray-100 p-4">
            ...
            {Object.keys(session?.user ?? {}).length > 3 ? (
               <p>
                  In this example, the whole session object is passed to the
                  page, including the raw user object. Our recommendation is to{' '}
                  <em>only pass the necessary fields</em> to the page, as the
                  raw user object may contain sensitive information.
               </p>
            ) : (
               <p>
